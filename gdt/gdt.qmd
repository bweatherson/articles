...
And if there is an intuition here, it is that it's better to choose Down rather than Up.[^18] This violates Exit Principle, and it seems incoherent to say that one would choose Down in this game, when Down just means playing Down in round 2, and if one were to reach round 2, one would prefer Up.
