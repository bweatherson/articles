...
Following Williamson (\citeproc{ref-Williamson2013}{2013}), there has
been a resurgence of attention in the idea that everything exists
...
particularly convincing to necessitists. That's not worrying on it's
own; lots of good arguments aren't convincing to theorists committed to
the other side. The other two concerns, however, are more pressing.
...
(\citeproc{ref-Williamson2013}{Williamson 2013, 2})
\end{quote}

On Williamson's own account, necessitism looks like what we get to in
step 3 of the little argument. The distinction between the worlds
...
Williamson, Timothy. 2013. {``How Deep Is the Distinction Between a
Priori and a Posteriori Knowledge.''} In \emph{The a Priori in
Philosophy}, edited by Albert Casullo and Joshua C. Thurow, 291--312.
