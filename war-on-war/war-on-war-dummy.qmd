...
abstract: "Really, why aren't they? What has gone wrong. I've been told that you've been bold etc. I need to fix this because"
date: today
format: 
    html:
      theme: 
    ...
    pdf: 
      classoption: twoside
      geometry: "left=1in,right=1in,top=0.8in,bottom=0.8in,paperheight=9.5in,paperwidth=6.5in"
      mathspec: false
      ...
      include-in-header:
        text: |
          ...
          \renewenvironment{abstract}
           {\vspace{-2cm}\quotation\small\noindent\rule{\linewidth}{.5pt}\par\smallskip
           \noindent }
           {\par\noindent\rule{\linewidth}{.5pt}\endquotation}
editor: visual
bibliography: war-on-war.bib
csl: ../../quarto-articles/chicago-with-note.csl
