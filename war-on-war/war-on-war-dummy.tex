...
\usepackage{xcolor}
\usepackage[left=1in,right=1in,top=0.8in,bottom=0.8in,paperheight=9.5in,paperwidth=6.5in]{geometry}
...
\maketitle
\begin{abstract}
Really, why aren't they? What has gone wrong. I've been told that you've
been bold etc. I need to fix this because
\end{abstract}
