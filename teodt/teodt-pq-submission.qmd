...
format:
    ...
    pdf: 
      ...
      pdf-engine: xelatex
      date-format: "YYYY"
      output-file: "The End of Decision Theory - Philosophical Quarterly"
      include-in-header:
        - file: quarto2024.tex
        - text: |
...
If you're reading a paper like this, you're probably familiar with seeing papers defending this or that decision theory.^[Word count. Body text plus footnotes: 5692; Abstract: 150; References: 538.] Familiar decision theories include:
...
- @fig-map: "A map of the 48 contiguous states of the USA, with dots at the locations of 257 major cities."
- @fig-farthest: "@fig-map plus a jagged path through the 257 cities."
- @fig-two-opt: "A similar drawing to @fig-farthest with a smoother path."
- @fig-best: "Another path through the 257 cities with a different path, the shortest one the author knows."
