...
format:
    ...
    docx:
      ...
      output-file: "The End of Decision Theory - AJP"
    pdf: 
      classoption: twoside
      geometry: "left=1.2in,
                 right=1.2in,
...
# What is Decision Theory a Theory Of? {#sec-what}
...
Other theories haven't had snappy 'isms' applied to them, such as the non-standard version of Causal Decision Theory that Dmitri @Gallow2020 defends, or the pluralist decision theory that Jack @Spencer2021 defends, or the broadly ratificationist theory that Melissa @Fusco2024 defends.
...
# Decision Theory as Idealisation {#sec-idealisations}
...
Until very recently, used cars sold at a huge discount to new cars, even when the cars were just a few months old with almost no usage. For a long time there was no agreed upon explanation for this phenomenon. The most common theory was that it reflected a preference, or perhaps a prejudice, on the part of buyers. George @Akerlof1970 showed how this discount could be explained in a model of perfectly rational agents. His model makes the following assumptions.
...
# Theories and Theorists {#sec-theorists}
