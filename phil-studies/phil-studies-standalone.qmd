...
The biggest trend in @fig-five-topics is the drop in importance of philosophy of language. It's worth isolating that part of the graph to see how dramatic it is, as in @fig-language. I've also added a trend-line to make the pattern more visible.
