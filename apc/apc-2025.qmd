...
year_by_year_average_plot <- year_by_year_average |>
  ...
  xlab(element_blank()) +
  scale_x_continuous(breaks = (498:500)*20) +
...
Before 1965, the philosophical work with the most lasting significance was not done in journals. And those works of lasting significance that were in things one might call journals often are not indexed by Web of Science. So we don't have "Is Knowledge Justified True Belief?" [@Gettier1963] because they don't index _Analysis_ until 1975, and we don't have Austin's two most important papers - "Ifs and Cans" and "A Plea for Excuses" [@Austin1956; @Austin1956b] because their venues aren't indexed as journals at all. We do have important papers by @WOSA1956CGZ5700001, @WOSA1958CDL1000001, and @WOSA1956CGZ5700001. But these made much less impact than books from the same time, especially _Word and Object_ [@Quine1960] and _The Structure of Scientific Revolutions_ [@Kuhn1962], or than books written by the authors of some of these papers, such as @Anscombe1957 and @Strawson1959.
...
- Practical ethics [@WOS:A1971Y116900003, @WOSA1972Z066400001];
