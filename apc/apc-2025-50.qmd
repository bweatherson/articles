...
load("/Users/weath/Documents/citations-2025/philo_bib_with_oa.RData")
load("/Users/weath/Documents/citations-2025/philo_cite_with_oa.RData")
...
active_philo_bib <- philo_bib_with_oa |>
  filter(year >= start_year, year <= end_year) |>
  filter(journal %in% active_journal_list) |>
  filter(!str_sub(id, end = 3) == "WOS" | !year == 2022)

active_philo_cite <- philo_cite_with_oa |>
  filter(
