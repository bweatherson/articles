...
That said, if you were going to look at any of them, this might be the one. Adam @Elga2010 has this argument against imprecise credences that I think can be restated, perhaps more forcefully, in the guessing framework.

Let *p* have vague credence, and *q* a precise credence near the middle of the range *p* is in. Let *e* be some very very unlikely lottery proposition, whose probability is smaller than the range between *p*'s upper and lower credence. Guesser then is asked to make guesses in the following two situations.

- First, guess *p* or *q*.
- Second, guess *p* ∨ *e* or *q*.

Elga says that on a standard way of understanding imprecise credence, it's ok to guess *p* the first time, and *q* the second time. But that pair of guesses is weakly dominated by guessing *q* the first time and *p* ∨ *e* the second time. So an argument.

1. If imprecise credences are ok, the two guesses are permissible.
2. The two guesses form a strategy that's weakly dominated.
3. It's not permisible to play a strategy that's weakly dominated.
4. Therefore, imprecise credences are not ok.

I think 1 isn't right, though the argument against it impacts the discussion of contraction. I guess some of what Jim has been saying recently suggests he thinks 3 is false. In any case, it's an interesting argument.

## Digression Two: Negative Dominance
...
## Digression Three: Guessing Functions
...
## Digression Four: Imprecision and Representors
...
## Digression Five: Linking the digressions up
