...
\cehead{Draft of October 27, 2025}
\makeatletter
...
sets of options. A common assumption, often implicit, is that norms
about preferences are prior to norms on values and choices. One way to
put this assumption, following Amartya Sen
(\citeproc{ref-Sen1970sec}{1970/2017}), is that choice functions are
\emph{binary}; they are grounded in binary relations of preference and
indifference.
...
(\citeproc{ref-GulPesendorfer2008}{Gul \& Pesendorfer, 2008, p. 24})
\end{quote}
...
choiceworthiness. In familiar terminology\footnote{See, for instance,
  Hansson \& Grüne-Yanoff (\citeproc{ref-sep-preferences}{2024}), where
...
Social Welfare'' (\citeproc{ref-Sen1970sec}{Sen, 1970/2017}), and also
on the literature that grew out of that book.
...
involving infinite goods.\footnote{See, e.g., Nover \& Hàjek
  (\citeproc{ref-Nover2004}{2004}), or Goodman \& Lederman
...
(\citeproc{ref-RamseyTruthProb}{1926}) or von Neumann \& Morgenstern
...
Neumann \& Morgenstern (\citeproc{ref-vNM1944yaml}{1944}), which I think
is still broadly endorsed by decision theorists. The aim is to put norms
on preference, and hence on values and choices. But these norms are
almost always defined in terms of other preferences. For example, if one
strictly prefers \emph{x} to \emph{y}, and \emph{y} to \emph{z}, one
...
transitive. Sen (\citeproc{ref-Sen1970sec}{1970/2017, p. 66}) notes that
if \emph{P} is transitive and \emph{R} is `complete' in the sense that
...
In his economic work, Sen (\citeproc{ref-Sen1970sec}{1970/2017}) uses
the term `completeness' for a slightly different property of preference
relations, namely \emph{xRy}~∨~\emph{yRx}. In both cases the claim is
that some preference relation is guaranteed to hold in one direction or
other. The issue is whether that relation is the disjunction of \emph{P}
and \emph{E}, or the disjunction of \emph{P} and \emph{I}.
...
(\citeproc{ref-Sen1970sec}{1970/2017}), and I'll use his terminology for
them. The fifth is due to Aizerman \& Malishevski
(\citeproc{ref-Aizerman1981}{1981}), and is usually named after
Aizerman. The sixth is discussed by Blair, Bordes, Kelly, \& Suzumura
...
(\citeproc{ref-Sen1970sec}{1970/2017, pp. 323--326}) discusses two
...
from the pair. Sen (\citeproc{ref-Sen1970sec}{1970/2017, p. 319}) calls
these functions `basic binary', but the distinction marked by `basic'
doesn't matter given that \emph{R} is a semiorder and α holds. Since
we're assuming α, we'll use the simpler version.
...
cases. The earliest example of this form I know is from Luce \& Raiffa
...
{[}i.e., (4){]} is violated. (\citeproc{ref-LuceRaiffa1957}{Luce \&
Raiffa, 1957, p. 375})
\end{quote}

An example with the same structure, involving a boy, a bicycle, and a
bell, is discussed by Lehrer \& Wagner
...
(\citeproc{ref-Sen1970sec}{Sen, 1970/2017, p. 320}). We're not going to
be very interested in δ, but we will be very interested in γ.
...
\& Ok (\citeproc{ref-EvrenOk2011}{2011})). In this approach we find a
...
Luce \& Raiffa (\citeproc{ref-LuceRaiffa1957}{1957}) discuss what they
...
Imagine someone were convinced by the arguments in Dorr, Nebel, \& Zuehl
...
Pierre's.\footnote{I'm focussing here on the argument in Dorr et al.
...
(\citeproc{ref-Sen2004}{Sen, 2004, p. 53}) of each skill for the task at
...
(\citeproc{ref-Lederman2025}{forthcoming}).\footnote{See also Lederman
  (\citeproc{ref-Lederman2023}{2023}), and Tarsney, Lederman, \& Spears
...
(\citeproc{ref-Lederman2025}{Lederman, forthcoming, p. 13})
\end{description}
...
(\citeproc{ref-Lederman2025}{Lederman, forthcoming, p. 18}, emphasis in
original)
\end{quote}
...
following case mixes Levi's case with the main example in Tarsney et al.
(\citeproc{ref-LedermanEtAl2025}{forthcoming}). Ms.~Jones is now trying
to hire a programmer, and she has four candidates, each of which has the
skills in the four languages she cares about shown in
Table~\ref{tbl-programmers}.
...
a finite amount of time.'' (\citeproc{ref-Dreier2022}{Dreier, 2022}:
124)
\end{quote}
...
function, one not her own, constrain what she now values?\footnote{Compare
  the objection to supervaluationism in Fodor \& Lepore
...
Aizerman, M., \& Malishevski, A. (1981). General theory of best variants
choice: Some aspects. \emph{IEEE Transactions on Automatic Control},
\emph{26}, 1030--1040. doi: 10.1109/TAC.1981.1102777

\bibitem[\citeproctext]{ref-Armstrong1939}
Armstrong, W. E. (1939). The determinateness of the utility function.
\emph{The Economic Journal}, \emph{49}, 453--467. doi: 10.2307/2224802

\bibitem[\citeproctext]{ref-Armstrong1948}
Armstrong, W. E. (1948). Uncertainty and the utility function. \emph{The
Economic Journal}, \emph{58}, 1--10. doi: 10.2307/2226342

\bibitem[\citeproctext]{ref-Armstrong1950}
Armstrong, W. E. (1950). A note on the theory of consumer's behaviour.
\emph{Oxford Economic Papers}, \emph{2}, 119--122. doi:
10.1093/oxfordjournals.oep.a041384

\bibitem[\citeproctext]{ref-Arrow1951}
Arrow, K. J. (1951). \emph{Social Choice and Individual Values}. New
York: John Wiley \& Sons.

\bibitem[\citeproctext]{ref-sep-fechner}
Beiser, F. C. (2024). {Gustav Theodor Fechner}. In E. N. Zalta \& U.
Nodelman (Eds.), \emph{The {Stanford} encyclopedia of philosophy}
({S}ummer 2024).
...
\emph{Econometrica}, \emph{52}, 1007--1028. doi: 10.2307/1911196

\bibitem[\citeproctext]{ref-Blair1976}
Blair, D. H., Bordes, G., Kelly, J. S., \& Suzumura, K. (1976).
Impossibility theorems without collective rationality. \emph{Journal of
Economic Theory}, \emph{11}, 361--379. doi: 10.1016/0022-0531(76)90047-8

\bibitem[\citeproctext]{ref-Bradley2015}
Bradley, R. (2015). A note on incompleteness, transitivity and suzumura
consistency. In C. Binder, G. Codognato, M. Teschl, \& Y. Xu (Eds.),
\emph{Individual and collective choice and social welfare: Essays in
honor of nick baigent} (pp. 31--47). Berlin: Springer.

\bibitem[\citeproctext]{ref-Broome1997}
Broome, J. (1997). Is incommensurability vagueness? In R. Chang (Ed.),
\emph{Incommensurability, comparability and practical reason} (pp.
67--89). Cambridge, MA: Harvard University Press.

\bibitem[\citeproctext]{ref-Carr2020}
Carr, J. R. (2020). Imprecise evidence without imprecise credences.
\emph{Philosophical Studies}, \emph{177}, 2735--2758. doi:
10.1007/s11098-019-01336-7

\bibitem[\citeproctext]{ref-Chang1997}
Chang, R. (1997). Introduction. In R. Chang (Ed.),
\emph{Incommensurability, incomparability and practical reason.} (pp.
1--34). Cambridge, MA: Harvard University Press.

\bibitem[\citeproctext]{ref-Chang2017}
Chang, R. (2017). Hard choices. \emph{Journal of the American
Philosophical Association}, \emph{3}, 1--21. doi: 10.1017/apa.2017.7

\bibitem[\citeproctext]{ref-Chang2024}
Chang, R. (2024). What's so hard about hard choices? \emph{Erasmus
Journal for Philosophy and Economics}, \emph{17}, 272--286. doi:
10.23941/ejpe.v17i1.872

\bibitem[\citeproctext]{ref-Chernoff1954}
Chernoff, H. (1954). Rational selection of decision functions.
\emph{Econometrica}, \emph{22}, 422--443. doi: 10.2307/1907435

\bibitem[\citeproctext]{ref-Debreu1960}
Debreu, G. (1960). Review of \emph{individual choice behavior: A
theoretical analysis}, by {R. Duncan Luce}. \emph{American Economic
Review}, \emph{50}, 186--188.

\bibitem[\citeproctext]{ref-DorrEtAl2023}
Dorr, C., Nebel, J. M., \& Zuehl, J. (2023). The case for comparability.
\emph{Noûs}, \emph{57}, 414--453. doi: 10.1111/nous.12407

\bibitem[\citeproctext]{ref-Dreier2022}
Dreier, J. (2022). Blessed lives, bright prospects, incomplete
orderings. \emph{Oxford Studies in Normative Ethics}, \emph{12},
105--126. doi: 10.1093/oso/9780192868886.003.0006

\bibitem[\citeproctext]{ref-EvrenOk2011}
Evren, Özgür, \& Ok, E. A. (2011). On the multi-utility representation
of preference relations. \emph{Journal of Mathematical Economics},
\emph{47}, 554--563. doi: 10.1016/j.jmateco.2011.07.003

\bibitem[\citeproctext]{ref-Fara2001}
Fara, D. G. (2001). Phenomenal continua and the sorites. \emph{Mind},
\emph{110}, 905--936. doi: 10.1093/mind/110.440.905

\bibitem[\citeproctext]{ref-Fechner1860}
Fechner, G. (1860). \emph{Elemente Der Psychophysik}. Leipzig: Breitkopf
und H{ä}rtel.

\bibitem[\citeproctext]{ref-Fodor1996}
Fodor, J. A., \& Lepore, E. (1996). What cannot be valuated cannot be
valuated, and it cannot be supervaluated either. \emph{Journal of
Philosophy}, \emph{93}, 516--535. doi: 10.5840/jphil1996931013

\bibitem[\citeproctext]{ref-Gallow2020}
Gallow, J. D. (2020). The causal decision theorist's guide to managing
the news. \emph{The Journal of Philosophy}, \emph{117}, 117--149. doi:
10.5840/jphil202011739

\bibitem[\citeproctext]{ref-Gallow2024}
Gallow, J. D. (2024). It can be irrational to knowingly choose the best.
\emph{Australasian Journal of Philosophy}, \emph{103}, 540--546. doi:
10.1080/00048402.2024.2310197

\bibitem[\citeproctext]{ref-Gibbard2003}
Gibbard, A. (2003). \emph{Thinking How to Live}. Cambridge, MA: Harvard
University Press.

\bibitem[\citeproctext]{ref-Gibbard2014}
Gibbard, A. (2014). Social choice and the arrow conditions.
\emph{Economics and Philosophy}, \emph{30}, 269--284. doi:
10.1017/S026626711400025X

\bibitem[\citeproctext]{ref-GoodmanLederemanArXiV}
Goodman, J., \& Lederman, H. (2024). Maximal social welfare relations on
infinite populations satisfying permutation invariance.
https://arxiv.org/abs/2408.05851v2

\bibitem[\citeproctext]{ref-GulPesendorfer2008}
Gul, F., \& Pesendorfer, W. (2008). The case for mindless economics. In
A. Caplin \& A. Schotter (Eds.), \emph{Foundations of positive and
normative economics} (pp. 2--40). Oxford: Oxford University Press. doi:
10.1093/acprof:oso/9780195328318.003.0001

\bibitem[\citeproctext]{ref-Gustafsson2025}
Gustafsson, J. E. (forthcoming). A behavioural money-pump argument for
completeness. \emph{Theory and Decision}. Forthcoming. doi:
10.1007/s11238-025-10025-3

\bibitem[\citeproctext]{ref-Hansson2009}
Hansson, S. O. (2009). Preference-based choice functions: A generalized
approach. \emph{Synthese}, \emph{171}, 257--269. doi:
10.1007/s11229-009-9650-5

\bibitem[\citeproctext]{ref-sep-preferences}
Hansson, S. O., \& Grüne-Yanoff, T. (2024). {Preferences}. In E. N.
Zalta \& U. Nodelman (Eds.), \emph{The {Stanford} encyclopedia of
philosophy} ({W}inter 2024).
\url{https://plato.stanford.edu/archives/win2024/entries/preferences/};
Metaphysics Research Lab, Stanford University.

\bibitem[\citeproctext]{ref-Holton1999}
Holton, R. (1999). Intention and weakness of will. \emph{The Journal of
Philosophy}, \emph{96}, 241--262. doi: 10.2307/2564667

\bibitem[\citeproctext]{ref-Lederman2023}
Lederman, H. (2023). Incompleteness, independence, and negative
dominance. https://arxiv.org/abs/2311.08471

\bibitem[\citeproctext]{ref-Lederman2025}
Lederman, H. (forthcoming). Of marbles and matchsticks. \emph{Oxford
Studies in Epistemology}. Forthcoming

\bibitem[\citeproctext]{ref-LehrerWagner1985}
Lehrer, K., \& Wagner, C. (1985). Intransitive indifference: The
semi-order problem. \emph{Synthese}, \emph{65}, 249--256. doi:
10.1007/BF00869302

\bibitem[\citeproctext]{ref-Levi1986}
Levi, I. (1986). \emph{Hard Choices}. Cambridge: Cambridge University
Press.

\bibitem[\citeproctext]{ref-Lewis1981bn}
Lewis, D. (1981). Causal decision theory. \emph{Australasian Journal of
Philosophy}, \emph{59}, 5--30. doi: 10.1080/00048408112340011

\bibitem[\citeproctext]{ref-Luce1956}
Luce, R. D. (1956). Semiorders and a theory of utility discrimination.
\emph{Econometrica}, \emph{24}, 178--191. doi: 10.2307/1905751
...
Luce, R. D., \& Raiffa, H. (1957). \emph{Games and Decisions:
Introduction and Critical Survey}. New York: Wiley.

\bibitem[\citeproctext]{ref-Moss2015}
Moss, S. (2015). Time-slice epistemology and action under indeterminacy.
\emph{Oxford Studies in Epistemology}, \emph{5}, 172--194. doi:
...
\emph{Social Choice and Welfare}, \emph{2}, 147--160. doi:
10.1007/BF00437315

\bibitem[\citeproctext]{ref-Nover2004}
Nover, H., \& Hàjek, A. (2004). Vexing expectations. \emph{Mind},
\emph{113}, 237--249. doi: 10.1093/mind/113.450.237

\bibitem[\citeproctext]{ref-Pearce1984}
Pearce, D. G. (1984). Rationalizable strategic behavior and the problem
of perfection. \emph{Econometrica}, \emph{52}, 1029--1050. doi:
10.2307/1911197

\bibitem[\citeproctext]{ref-Peterson2017}
Peterson, M. (2017). \emph{An Introduction to Decision Theory} (Second).
Cambridge: Cambridge University Press. doi: 10.1017/9781316585061

\bibitem[\citeproctext]{ref-RamseyTruthProb}
Ramsey, F. (1926). Truth and probability. In D. H. Mellor (Ed.),
\emph{Philosophical papers} (pp. 52--94). Cambridge: Cambridge
University Press.

\bibitem[\citeproctext]{ref-Samuelson1938}
Samuelson, P. A. (1938). A note on the pure theory of consumer's
behaviour. \emph{Econometrica}, \emph{5}, 61--71. doi: 10.2307/2548836

\bibitem[\citeproctext]{ref-Sartre1946}
Sartre, J.-P. (1946/2007). Existentialism is a humanism. In A.
Cohen-Solal (Trans.), \emph{Existentialism is a humanism} (pp. 17--72).
New Haven: Yale University Press.

\bibitem[\citeproctext]{ref-Sen1969}
Sen, A. (1969). Quasi-transitivity, rational choice and collective
decisions. \emph{The Review of Economic Studies}, \emph{36}, 381--393.
doi: 10.2307/2296434

\bibitem[\citeproctext]{ref-Sen2004}
Sen, A. (2004). Incompleteness and reasoned choice. \emph{Synthese},
\emph{140}, 43--59. doi: 10.1023/B:SYNT.0000029940.51537.b3

\bibitem[\citeproctext]{ref-Sen1970sec}
Sen, A. (2017). \emph{Collective Choice and Social Welfare:} (An
expanded edition). Cambridge, MA: Harvard University Press. doi:
10.4159/9780674974616 (Original work published 1970)

\bibitem[\citeproctext]{ref-Skyrms1982}
Skyrms, B. (1982). Causal decision theory. \emph{Journal of Philosophy},
\emph{79}, 695--711. doi: 10.2307/2026547

\bibitem[\citeproctext]{ref-Spencer2023}
Spencer, J. (2023). Can it be irrational to knowingly choose the best?
\emph{Australasian Journal of Philosophy}, \emph{101}, 128--139. doi:
10.1080/00048402.2021.1958880

\bibitem[\citeproctext]{ref-LedermanEtAl2025}
Tarsney, C., Lederman, H., \& Spears, D. (forthcoming). A dominance
argument against incompleteness. \emph{Philosophical Review}.
Forthcoming. doi: 10.48550/arXiv.2403.17641
...
Weatherson, B. (2024). \emph{Knowledge: A Human Interest Story}.
Cambridge: Open Book Publishers. doi: 10.11647/obp.0425
