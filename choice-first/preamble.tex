...
%\fancyfoot[L]{\url{\articledoi}}						% geometry package
...
\renewenvironment{description}
 ...
 % Leave this at the very end. It doesn't play nice if it comes before some of the other declarations
%
% Nothing below this!
%     |    |    |      
%     V    V    V
