...
Imagine that Chooser is going to choose Up or Down, and there is a Demon who is very good at predicting Chooser's choice. 
...
1. Up is the only correct choice.
2. Down is the only correct choice.
3. Both Up and Down are correct choices.
4. More information is needed to say what the correct choice.

All four answers are defended in the literature.^[More accurately, for each answer, and theory that implies that answer is defended. Few people focus on exactly this puzzle, which is unfortunate.]

## Two Big Questions

1.  If those are the possible answers, what precisely is the question?
