...
Now as it turns out there are various helpful things you can say here, and I'm happy to talk about them more. But in the interests of time, I'll skip over some useful things that have been discovered (by other people) about efficiently getting to reasonable solutions to this problem.
...
## Objection - The General Theory of the Second Best
...
The Black-Scholes formula for pricing options is an example of the former, and the Akerlof story about how markets with information asymmetries work is an example of the latter.
...
:::: {.column width=65%}
- Why for most of the 20th century did lightly used cars sell at a heavy discount to new cars?
- Because that's what would happen if everyone followed standard decision theory, and sellers have more knowledge than buyers.
::::
...
You can't build models like Black-Scholes or Akerlof on lemons without a theory of rational action under uncertainty.
